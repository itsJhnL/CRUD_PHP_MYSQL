...
<div class="modal fade" id="Delete<?php echo $row['id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="function.php" method="POST">
                ...
                <div class="modal-body text-center" style="margin-top: -20px">
                    ...
                    <p><b>NAME: <u><?php echo $row['username']; ?></u></b></p>
